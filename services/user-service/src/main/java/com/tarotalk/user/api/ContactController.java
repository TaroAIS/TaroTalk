...
public class ContactController {
    ...
    @GetMapping("/owners")
    public ApiResponse<java.util.List<UUID>> listOwners(@RequestParam UUID contactUserId) {
        return ApiResponse.ok(contactService.listOwnerIdsByContactUserId(contactUserId));
    }
